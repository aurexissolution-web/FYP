...
const ms: Dictionary = {
  ...
  chat: {
    ...
    contactNotified: "{name} telah dimaklumkan",
  },
  appNav: {
    chat: "Chat",
    history: "Sejarah",
  ...
  history: {
    ...
    groupEarlier: "Lebih awal",
    emptyTitle: "Belum ada semakan",
    emptyBody: "Perbualan lepas anda akan dipaparkan di sini selepas anda memulakannya.",
    startChat: "Mulakan semakan",
    errorTitle: "Tidak dapat memuatkan sejarah anda sekarang.",
    retry: "Cuba lagi",
  },
  plan: {
    title: "Pelan",
    ...
    emptyBody: "Berbual dengan EmoBuddy dan minta pelan penjagaan diri untuk melihatnya di sini.",
    startChat: "Mulakan semakan",
    errorTitle: "Tidak dapat memuatkan pelan anda sekarang.",
    retry: "Cuba lagi",
  },
  profile: {
    title: "Profil",
    statStreak: "Hari berturut-turut",
    statCheckins: "Semakan",
    statCompleted: "Selesai",
    accountLabel: "Akaun",
  },
  emergencyContact: {
    title: "Kenalan kecemasan",
    subtitle: "Jika EmoBuddy mengesan krisis, orang ini akan dimaklumkan.",
    nameLabel: "Nama",
    relationshipLabel: "Hubungan",
    relationshipPlaceholder: "cth. Ibu, Rakan",
    phoneLabel: "Nombor telefon",
    saveButton: "Simpan kenalan",
    editButton: "Edit",
    removeButton: "Buang",
    removeConfirm: "Buang kenalan kecemasan ini?",
    cancelButton: "Batal",
    addButton: "Tambah kenalan kecemasan",
    emptyTitle: "Belum ada kenalan kecemasan",
    emptyBody: "Tambah seseorang yang perlu dimaklumkan jika EmoBuddy mengesan krisis.",
    savedNotice: "Kenalan kecemasan disimpan.",
    errorRequired: "Nama dan nombor telefon diperlukan.",
    errorGeneric: "Tidak dapat menyimpan kenalan kecemasan anda sekarang. Sila cuba lagi.",
  },
  footer: {
